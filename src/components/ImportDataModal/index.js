                      ...
                      <div id="left">
                        <div className="col-span-6 sm:col-span-4 p-1">
                          ...
                          <select
                            ...
                            className="block w-full py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                          >
                            <option value="" hidden>
                              Templets
                            </option>
                            ...
                            <div className="p-4 bg-white m-auto">
                                ...
                                <div className="input_field flex flex-col text-center">
                                  <label className="mb-2">
                                    ...
                                    <div
                                      ...
                                      } flex items-center justify-center text text-white  border border-gray-300 rounded font-semibold cursor-pointer p-1 px-3 `}
                                    >
                              ...
                              <div className="py-2">
                                <button
                                  ...
                                  } flex items-center text  text-white border border-gray-300 rounded font-semibold  `}
                                >
